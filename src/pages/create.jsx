...
const Create = () => {
  ...
  const handleChangeOnChangeFile = (e) => {
  ...
  return (
    <Layout>
      ...
      <form onSubmit={handleSubmit} style={inputStyles.formContainer}>
        <div style={inputStyles.constainer}>
        ...
        <div style={inputStyles.constainer}>
          ...
          <input type="file" name="cover" onChange={handleChangeOnChangeFile} style={inputStyles.input} />
          <div>{!! cover ? <img src={cover} alt="preview" width="200" /> : ""}
          </div>
        </div>
